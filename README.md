...
[![BourneIt Interface](docs/BourneIt.png)](https://bourneit-health-triage-engine.vercel.app/)
...
| **Language** | TypeScript, Python, JavaScript, CSS | `typescript`, `python`, `javascript`, `css` |
